...
class SortTypeMenuHelper(
    ...
    private val _sortByTopMenu: BottomMenu by lazy {
        BottomMenu(context).apply {
            ...
            addItem(R.id.sort_order_top_last_six_hour, context.getString(R.string.time_frame_last_hours_format, "6"))
            addItem(R.id.sort_order_top_last_twelve_hour, context.getString(R.string.time_frame_last_hours_format, "12"))
            ...
            addItem(R.id.sort_order_top_last_three_month, context.getString(R.string.time_frame_last_months_format, "3"))
            addItem(R.id.sort_order_top_last_six_month, context.getString(R.string.time_frame_last_months_format, "6"))
            addItem(R.id.sort_order_top_last_nine_month, context.getString(R.string.time_frame_last_months_format, "9"))
    ...
    private fun idToSortOrder(id: Int): SortType? =
        when (id) {
