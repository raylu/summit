...
fun CommunityViewState.toUrl(): String {
    val baseUrl = when (val community = this.communityState.community) {
        is Community.All -> "https://lemmy.world/home/data_type/Post/listing_type/All/data_type/Post"
        is Community.CommunityWrapper -> "${community.community.communityUrl}/data_type/Post"
        is Community.Local -> "${community.site}/home/data_type/Post/listing_type/Local"
    }
...
fun CommunityViewState.getShortDesc(context: Context): String =
    context.getString(
        ...
        communityState.community.getName(context),
