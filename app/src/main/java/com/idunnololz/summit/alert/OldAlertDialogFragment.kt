...
class OldAlertDialogFragment : DialogFragment() {
    ...
    class Builder {
        ...
        fun create(): OldAlertDialogFragment {
            val frag = OldAlertDialogFragment()
            frag.arguments = args
            return frag
        }

        fun create(parent: androidx.fragment.app.Fragment): OldAlertDialogFragment {
            val frag = create()
    ...
    interface AlertDialogFragmentListener {
        fun onPositiveClick(dialog: OldAlertDialogFragment, tag: String?)
        fun onNegativeClick(dialog: OldAlertDialogFragment, tag: String?)
    }
}
